...
export const STYLE_PROP_DEFS = {
  ...
  textDecoration: { prefix: '',        category: 'textDecoration',  attribute: 'text-decoration', transform: (v: string) => v },
  textTransform:  { prefix: '',        category: 'textTransform',   attribute: 'text-transform', transform: (v: string) => v },

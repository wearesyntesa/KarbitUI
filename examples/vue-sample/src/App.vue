        ...
        <div class="px-6 flex items-center">
          ...
          <nav class="flex items-center -mb-px">
            ...
            >
              ...
              <span
                v-if="isActive(n.to)"
                class="absolute bottom-0 left-4 right-4 h-0.5 bg-blue-600 dark:bg-blue-400"
              />
            </RouterLink>
          </nav>
          ...
          <button
            ...
            @click="toggleDark"
          >
            <svg v-if="dark" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="square">
